<html lang="en" dir="ltr">
 ...
 <script src="js/alertbox.js"></script>
  ...
  <div class="container-fluid">
    <div id="alertbox"></div>
    <div align="left">
    <p style="font-size: 24px;"><span class="label label-primary">เพิ่มข้อมูลเที่ยวรถ</span></p>
    </div>
      ...
      <form class="form-horizontal">
        <div class="form-group">
          <label for="van_id" class="col-sm-1 control-label w">เส้นทางรถ :</label>
            <div class="col-sm-9">
              <select class="form-control" id="route_r" style="width: 250px;" required>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#save_route').on('click', function(){
      ...
      if(route != '' && time_sum != '' && van_id != '' && time_finish != '' && time_start != '' && van_id != null){
        $.post("sql_round.php", {
          cmd : 'insert',
          route_id : route,
          time : time_sum,

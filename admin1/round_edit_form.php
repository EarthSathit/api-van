<html lang="en" dir="ltr">
 ...
 <script src="js/alertbox.js"></script>
  ...
  <div class="container-fluid">
    <div id="alertbox"></div>
    <div align="left">
    <p style="font-size: 24px;"><span class="label label-primary">แก้ไขข้อมูลเที่ยวรถ</span></p>
    </div>
      ...
      <form class="form-horizontal">
          ...
          <label for="van_id" class="col-sm-1 control-label w">เส้นทางรถ :</label>
            <div class="col-sm-9">
              <select class="form-control" id="route_id" style="width: 250px;">
                <option value="" disabled selected>เส้นทางรถ</option>
                <?php
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <select class="form-control" name="" id="van_id" style="width: 150px;" required>
            ...
            <?php
                ...
                if ($num_row != 0){
                  foreach($stmt as $rows){ ?>
                  <option value="<?php echo $rows['van_id']; ?>" <?php if($rows['van_id'] == $row['van_id']) echo "selected"; ?>>
                  <?php echo $rows['van_id']; ?></option>
               <?php } } ?>
               ?>
            </select>
          </div>
    ...
    $('#edted_round').on('click', function(){
     ...
     $.post("sql_round.php", {
      ...
      if (data == '1') {
        ...
        alert_warning('รถตู้คันนี้มีเที่ยวรถแล้ว กรุณาเลือกรถตู้คันอื่น')
        $('#van_id').val('')
        $('#van_id').focus()
      }else {
